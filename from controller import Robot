           ...
           if ds_value >0.5:
               if object_detected_counter[-1] == 0:
                   ...
                   if GetBearingIndegrees() < 180:
                       x_coordinate = gps.getValues()[0] - ((distance*np.sin(GetBearingIndegrees()*np.pi/180))+ 0.08)
            ...
            print("Polar Coordinate:", detected_dict)
            #print(global_coordinate_x)
            #print(global_coordinate_z)
            print("Global Coordinate:",coordinate_dict)
            print("#####################")
